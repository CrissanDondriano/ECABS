...
@section('content')
    ...
    <div class="container-fluid py-2 content-wrapper rounded">
                ...
                <div class="card reservation-container">
                    <div class="card-header bg-profile text-white d-flex flex-row"
                        ...
                        <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
                            ...
                            <button type="button" id="updateUserProfile" class="btn btn-outline-dark border-4 text-uppercase design-text fw-bold"
                                style="z-index: 1;" data-bs-toggle="modal" data-bs-target="#editProfileModal" data-toggle="tooltip" title="Edit Profile">
                                Edit profile
                            </button>
                        </div>
                    ...
                    <div class="p-4 text-black" style="background-color: #f8f9fa;">
                        <div class="d-flex justify-content-end text-center py-1">
                            <div class="px-3">
                                <p class="mb-4 h6 badge rounded-pill d-inline-block bg-primary">Renters</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                                                    ...
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="form-label design-text text-muted">Contact Number
                                                                <span class="text-danger">*</span></label>
                                                            <input type="text" id="updateUserContact"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="form-label design-text text-muted">Birth of Date
                                                                <span class="text-danger">*</span></label>
                                                            <input id="updateUserBirthdate" class="form-control"
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input id="updateUserAddress" class="form-control"
                                                                type="text" value=""
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label design-text text-muted">Email Address
                                                    <span class="text-danger">*</span></label>
                                                <input id="updateUserEmail" class="form-control"
                                                    type="email" value=""
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <label for="exampleInputPassword2"
                                                    ...
                                                    <span class="text-danger">*</span></label>
                                                <input id="updateUserPass" class="form-control"
                                                    type="password" value=""
                                            ...
                                            <div class="col-md-12">
                                                <label for="exampleInputPassword3"
                                                    ...
                                                    <span class="text-danger">*</span></label>
                                                <input id="updateUserConfirm" class="form-control"
                                                    type="password" value=""
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <label for="exampleInputPassword1"
                                                    ...
                                                    <span class="text-danger">*</span></label>
                                                <input id="updateUserOldPass" class="form-control"
                                                    type="password" value=""
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <label for="exampleInputPassword2"
                                                    ...
                                                    <span class="text-danger">*</span></label>
                                                <input id="updateUserNewPass" class="form-control"
                                                    type="password" value=""
                                                    placeholder="Enter your New Password">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="exampleInputPassword3"
                                                    class="form-label design-text text-muted">Confirm Password
                                                    <span class="text-danger">*</span></label>
                                                <input id="updateUserNewConfirm" class="form-control"
                                                    type="password" value=""
                                                    placeholder="Enter your Password">
                                            </div>
                                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="updateUserProfileBtn">Update profile</button>
                </div>
            </div>
        </div>
    </div>
