                ...
                <div class="my-3">
                    ...
                    <div class="list-group mb-5 shadow">
                        ...
                        <div class="list-group-item">
                            <div class="row align-items-center">
                                <div class="col">
                                    <strong class="mb-2">Maintenance Mode</strong>
                                    <p class="text-muted mb-0">Maintenance mode means our platform is undergoing maintenance
                                        or updates. You may experience temporary unavailability during this time.</p>
                                </div>
                                <div class="col-auto">
                                    @if ($maintenanceSettings->value == 1)
                                        <button id="maintenanceToggleBtn" class="btn btn-primary btn-sm">Enable</button>
                                    @else
                                        <button id="maintenanceToggleBtn" class="btn btn-danger btn-sm">Disable</button>
                                    @endif
                                </div>
                            </div>
                        </div>
