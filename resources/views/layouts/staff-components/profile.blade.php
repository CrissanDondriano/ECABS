                ...
                <div class="card inventory-container">
                    <div class="card-header bg-profile text-white d-flex flex-row"
                        ...
                        <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
                            <img src="{!! url('assets/images/temp-profile.jpg') !!}" alt="Generic placeholder image"
                                class="img-fluid img-thumbnail mt-4 mb-2" style="width: 150px; z-index: 1">
                            <button type="button" id="updateStaffProfile" class="btn btn-outline-dark border-4 text-uppercase design-text fw-bold"
                    ...
                    <div class="p-4 text-black" style="background-color: #f8f9fa;">
                        <div class="d-flex justify-content-end text-center py-1">
                            <div class="px-3">
                                <p class="mb-4 h6 badge rounded-pill d-inline-block bg-primary">Staff</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                                                    ...
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="form-label design-text text-muted">Contact Number
                                                                <span class="text-danger">*</span></label>
                                                            <input type="text" id="updateStaffContact"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="form-label design-text text-muted">Birth of Date
                                                                <span class="text-danger">*</span></label>
                                                            <input id="updateStaffBirthdate" class="form-control"
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input id="updateStaffAddress" class="form-control"
                                                                type="text" value=""
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label design-text text-muted">Email Address
                                                    <span class="text-danger">*</span></label>
                                                <input id="updateStaffEmail" class="form-control"
                                                    type="email" value=""
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <label for="exampleInputPassword2"
                                                    ...
                                                    <span class="text-danger">*</span></label>
                                                <input id="updateStaffPass" class="form-control"
                                                    type="password" value=""
                                            ...
                                            <div class="col-md-12">
                                                <label for="exampleInputPassword3"
                                                    ...
                                                    <span class="text-danger">*</span></label>
                                                <input id="updateStaffConfirm" class="form-control"
                                                    type="password" value=""
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <label for="exampleInputPassword1"
                                                    ...
                                                    <span class="text-danger">*</span></label>
                                                <input id="updateStaffOldPass" class="form-control"
                                                    type="password" value=""
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <label for="exampleInputPassword2"
                                                    ...
                                                    <span class="text-danger">*</span></label>
                                                <input id="updateStaffNewPass" class="form-control"
                                                    type="password" value=""
                                                    placeholder="Enter your New Password">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="exampleInputPassword3"
                                                    class="form-label design-text text-muted">Confirm Password
                                                    <span class="text-danger">*</span></label>
                                                <input id="updateStaffNewConfirm" class="form-control"
                                                    type="password" value=""
                                                    placeholder="Enter your Password">
                                            </div>
                                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="updateStaffProfileBtn">Update profile</button>
                </div>
            </div>
        </div>
    </div>
